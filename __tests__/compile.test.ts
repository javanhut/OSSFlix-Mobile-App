...
describe("compile check: every src/ module imports cleanly", () => {
  const modules: Array<[string, () => unknown]> = [
    ...
    [
      ...
      () => require("../src/storage/sessionStorage"),
    ],
    [
      "src/storage/downloadsStorage",
      () => require("../src/storage/downloadsStorage"),
    ],
    ["src/state/session", () => require("../src/state/session")],
    ["src/state/downloads", () => require("../src/state/downloads")],
    ["src/types/downloads", () => require("../src/types/downloads")],
    [
      "src/downloads/downloadManager",
      () => require("../src/downloads/downloadManager"),
    ],
    ...
    [
      ...
      () => require("../src/components/EmptyState"),
    ],
    [
      "src/screens/ServerConnectScreen",
      () => require("../src/screens/ServerConnectScreen"),
    ],
    [
      "src/screens/ProfileLookupScreen",
      () => require("../src/screens/ProfileLookupScreen"),
    ],
    ["src/screens/SignInScreen", () => require("../src/screens/SignInScreen")],
    [
      "src/screens/RegisterScreen",
      () => require("../src/screens/RegisterScreen"),
    ],
    ["src/screens/HomeScreen", () => require("../src/screens/HomeScreen")],
    [
      "src/screens/LibraryScreen",
      () => require("../src/screens/LibraryScreen"),
    ],
    ["src/screens/SearchScreen", () => require("../src/screens/SearchScreen")],
    [
      "src/screens/WatchlistScreen",
      () => require("../src/screens/WatchlistScreen"),
    ],
    [
      "src/screens/TitleDetailsScreen",
      () => require("../src/screens/TitleDetailsScreen"),
    ],
    ["src/screens/PlayerScreen", () => require("../src/screens/PlayerScreen")],
    [
      "src/screens/DownloadsScreen",
      () => require("../src/screens/DownloadsScreen"),
    ],
    [
    ...
    [
      ...
      () => require("../src/providers/AppProviders"),
    ],
  ];
