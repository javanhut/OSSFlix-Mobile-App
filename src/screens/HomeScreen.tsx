...
export function HomeScreen() {
  ...
  const refreshing =
    ...
    continueWatchingQuery.isRefetching ||
    watchlistQuery.isRefetching;
  const handleRefresh = () => {
    void Promise.all([
  ...
  const categoryRows = allCategoryRows.filter((row) =>
    BASIC_GENRES.has(row.genre),
  );

  const featured = (() => {
    const newlyAdded = allCategoryRows.find(
